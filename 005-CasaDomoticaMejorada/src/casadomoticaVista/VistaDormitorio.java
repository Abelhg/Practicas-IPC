 ...
 */
public class VistaDormitorio extends javax.swing.JFrame {

    /**
     * Creates new form VistaSalon
     */
    public VistaDormitorio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaDormitorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaDormitorio().setVisible(true);
            }
        });
    }
